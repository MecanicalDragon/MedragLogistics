...
CREATE TABLE TRUCK (
  ...
  CURRENT_CITY_ID INT                                        ,
  FOREIGN KEY (CURRENT_CITY_ID) REFERENCES CITY (ID)ON DELETE SET NULL ON UPDATE CASCADE
)
  ENGINE = InnoDB;
...
CREATE TABLE DRIVER (
  ...
  FOREIGN KEY (CURRENT_CITY_ID) REFERENCES CITY (ID)ON DELETE SET NULL ON UPDATE CASCADE,
  FOREIGN KEY (CURRENT_TRUCK_ID) REFERENCES TRUCK (ID)ON DELETE SET NULL ON UPDATE CASCADE
)
  ENGINE = InnoDB;
