...
<div class="container">
    <div class="jumbotron" style="margin-top: 20px;">
        <div class="text-center">
            ...
            <h3>Cargo list of customer ${owner.name} ${owner.surname}, document # ${owner.passport}</h3>
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="cargo-Table">
                ...
                <c:forEach items="${cargoList}" var="cargoItem">
                    <tr class="odd gradeX">
                        <td>${cargoItem.name}</td>
                        <td>${cargoItem.weight}</td>
                        <td>${cargoItem.departure}</td>
                        <td>${cargoItem.destination}</td>
                    </tr>
                </c:forEach>
            ...
            <div class="row">
                ...
                <a class="btn btn-success" href="/whm-order/compile" role="button">Compile order</a>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                ...
                                <form:form class="form" id="addNewCargo" method="post" modelAttribute="cargo"
                                    ...
                                    <div class="row">
                                        <form:input name="weight" placeholder="weight" path="weight" autofocus="true"
                                                    class="form-control col-8"/>
                                    </div>
                                    <div class="row">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-success" form="addNewCargo" type="submit">Add new Cargo
                            </button>
                        </div>
                    </div>
                </div>
